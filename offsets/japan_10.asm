...
ELIF DEF(_SILVER)
	define_home Bank00_FreeSpace,  $3fc0
ENDC
IF DEF(_GOLD)
	define_location Bank01_FreeSpace,  $7f9f
ELIF DEF(_SILVER)
	define_location Bank01_FreeSpace,  $7fce
ENDC
	define_location Bank02_FreeSpace,  $bbc4
	define_location Bank3a_FreeSpace, $ebfb7
IF DEF(_GOLD)
	define_location Bank04_FreeSpace,  $13f54
ELIF DEF(_SILVER)
	define_location Bank04_FreeSpace,  $13f8b
ENDC
...
; bank 3a
	...
	define_location EvolveAfterBattle_PlayCaughtSFX, $10, $64d1
